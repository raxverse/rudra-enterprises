  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1.5 border border-amber-100 group flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-1">
        <h3 className="text-lg font-bold text-amber-900 mb-1.5" style={{ fontFamily: "'Playfair Display', serif" }}>
          {product.name}
        </h3>
        {product.weight && (
        ...
        <a
          ...
          className="mt-auto flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold py-2.5 px-4 rounded-xl transition-all duration-200 hover:shadow-md"
        >
